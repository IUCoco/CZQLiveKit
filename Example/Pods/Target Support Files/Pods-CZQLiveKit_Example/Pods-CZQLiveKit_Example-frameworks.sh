...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CZQLessonCategoryKit/CZQLessonCategoryKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CZQLiveKit/CZQLiveKit.framework"
